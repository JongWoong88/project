...
<head>
    ...
    <title>게시판 등록</title>
    <link rel="stylesheet" href="/project1/css/reset.css"/>
    <link rel="stylesheet" href="/project1/css/contents.css"/>
    <script src='/project1/smarteditor/js/HuskyEZCreator.js'></script>
    <script src="/project1/js/function.js"></script>
